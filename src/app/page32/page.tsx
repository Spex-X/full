...
export default function Page32() {
  ...
  const options = [
    { id: "confianca", label: "Me sentir mais confiante com o meu corpo.", icon: "✨" },
    { id: "saude", label: "Ficar mais saudável e ter mais energia.", icon: "💪" },
    { id: "roupas", label: "Me sentir bem nas minhas roupas.", icon: "👗" },
    { id: "parto", label: "Recuperar o corpo e a autoestima após o parto.", icon: "🤰" },
  ...
  const handleContinue = () => {
    ...
    trackMetaPixelCustomEvent('QuizStep24');
    setTimeout(() => {
      router.push("/page33");
    }, 300);
  };
