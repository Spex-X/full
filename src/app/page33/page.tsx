...
export default function Page33() {
  ...
  const options = [
    { id: "sei-consigo", label: "Eu sei que consigo!", icon: "💪" },
    { id: "tentar-novo", label: "Estou disposta a tentar algo novo!", icon: "🌟" },
    { id: "inseguranca", label: "Ainda sinto insegurança, mas quero mudar!", icon: "🙏" }
  ];
  ...
  const handleContinue = () => {
    ...
    trackMetaPixelCustomEvent('QuizStep25');
    setTimeout(() => {
      router.push("/page34");
    }, 300);
  };
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-6">
          <div className="text-center mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-800 mb-4">
              Quão confiante você está em entrar em forma até o dia 12 de agosto?
            </h2>
          </div>
